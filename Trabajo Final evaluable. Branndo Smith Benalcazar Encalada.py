class Producto:
    ...
    # Métodos getter y setter para acceder a los atributos privados(Usando el decorador @proerty)
    @property
    def nombre(self):
...
class Inventario:
    # La clase Inventario gestiona el almacenamiento y las operaciones relacionadas con los productos dentro de un inventario.
    def __init__(self):
        self.productos = []
